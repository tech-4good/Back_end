...
@Schema(description = "Objeto de requisição para auxiliar entre beneficiado e auxílio governamental")
public class BeneficiadoHasAuxilioRequestDto {
    ...
    public BeneficiadoHasAuxilioRequestDto() {
    }

    public BeneficiadoHasAuxilioRequestDto(Integer beneficiadoId, Integer auxilioGovernamentalId) {
