...
@Schema(description = "Entidade JPA para tipo de morador")
@Entity
@Table(name = "tipo_morador")
public class TipoMoradorEntity {
    ...
    @ManyToOne
    @JoinColumn(name = "fk_beneficiado", referencedColumnName = "id_beneficiado")
    private BeneficiadoEntity beneficiado;

    public TipoMoradorEntity() {
    }

    public TipoMoradorEntity(Integer idTipoMorador, Integer quantidadeCrianca, Integer quantidadeAdolescente, Integer quantidadeJovem, Integer quantidadeIdoso, Integer quantidadeGestante, Integer quantidadeDeficiente, Integer quantidadeOutros, EnderecoEntity endereco, BeneficiadoEntity beneficiado) {
