...
public class EnderecoSummarizedDto {
    ...
    @Schema(description = "Nome do estado", example = "SP - São Paulo")
    ...
    public EnderecoSummarizedDto() {
    }

    public EnderecoSummarizedDto(Integer id, String logradouro, String numero, String complemento, String bairro,
                                String cidade, String estado, String cep, String tipoCesta, LocalDate dataEntrada,
                                LocalDate dataSaida, String moradia, String tipoMoradia, String status) {
        this.id = id;
